<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Agregar SubCuenta</h6>
    </div>
    <div class="card-body">

        <button class="btn btn-warning mb-3" id="regresarSubCatalogo">
            <i class="fa fa-arrow-left"></i> Regresar
        </button>

        <form name="frmAddCatalogo" id="frmAddSubCatalogo">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="hidden" class="form-control" placeholder="numero Cuenta" id="numeroCuenta"
                        name="numeroCuenta">
                    <input class="form-control" type="hidden" placeholder="nivel" name="nivelCuenta" id="nivelCuenta">

                    <label for="Numero">Nombre Cuenta:</label>
